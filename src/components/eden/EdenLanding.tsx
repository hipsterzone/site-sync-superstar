...
export default function EdenLanding() {
  ...
  const galleryItemsRef = useRef<Array<HTMLDivElement | null>>([]);
  ...
  const galleryItems: GalleryItem[] = useMemo(
    () => [
      ...
      {
        category: "events",
        src: "https://images.pexels.com/photos/5638612/pexels-photo-5638612.jpeg?auto=compress&cs=tinysrgb&w=800",
        alt: "Evento privato",
        tag: "Eventi",
        title: "Feste private",
      },
  ...
  useEffect(() => {
    ...
    const onMove = (e: MouseEvent) => {
      ...
      el.style.transform = `translate3d(${x * 14}px,${y * 14}px,0) rotateX(${y * -4}deg) rotateY(${x * 4}deg)`;
    };
  ...
  useEffect(() => {
    ...
    const visibleItems = galleryItemsRef.current.filter(Boolean) as HTMLDivElement[];
    visibleItems.forEach((item, index) => {
      window.setTimeout(() => item.classList.add("visible"), index * 100);
    });
  }, [galleryRevealed]);
  ...
  function onGalleryFilter(next: GalleryFilter) {
    ...
    // reset visibilità (1:1)
    galleryItemsRef.current.forEach((el) => el?.classList.remove("visible"));
    window.setTimeout(() => {
      galleryItemsRef.current.forEach((el) => el?.classList.add("visible"));
    }, 50);
  }
        ...
        <main>
          ...
          <section className="hero">
            ...
            <div className="hero-inner">
              <div className="hero-content" id="hero-content" ref={heroContentRef}>
          ...
          <section id="cucina" className="cucina-section reveal-on-scroll">
            <div className="cucina-shell">
              ...
              >
                <div className="panel-layout">
                  ...
                  <div className="panel-content">
                    <div
                      className="panel-price-badge"
                      aria-label="Prezzo indicativo percorso terra"
                      style={{ borderColor: "hsla(var(--eden-gold) / 0.4)" }}
                    >
                      <span className="price-from">da</span>
          ...
          <section id="gallery" className="gallery-section reveal-on-scroll">
            <div className="gallery-shell">
              ...
              <div className="gallery-grid">
                {galleryItems.map((item, idx) => {
                  const isShown = galleryFilter === "all" || item.category === galleryFilter;
                  return (
                    <div
                      key={idx}
                      ref={(el) => {
            ...
            >
              ...
              <img src={lightboxSrc} alt="Anteprima" />
                  ...
                  <div className="contact-list">
                    <div className="c-item">
                      ...
                      <span className="c-val">
                        Via Santa Maria della Stella, 66<br />
                        70010 Adelfia (BA)
                      </span>
                    </div>
                    <div className="c-item">
                      ...
                      <span className="c-val">
                        ...
                        <br />
                        <a href="tel:+393497152524">349 715 2524 (WhatsApp)</a>
                      </span>
                    </div>
                    <div className="c-item">
                      ...
                      <span className="c-val">
                        ...
                        <br />
                        <em style={{ color: "hsla(var(--eden-gold) / 1)" }}>Mercoledì chiuso</em>
                      </span>
                    </div>
                  </div>
                </div>
